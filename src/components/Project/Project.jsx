                    ...
                    <div className="position-relative modal-open rounded-10 mb-3 mb-md-0">
                      ...
                      <div className="position-absolute large-article-info p-0 p-lg-4 p-md-3">
                        <h3 className="title_blo font-weight-bold mt-2 mt-md-0 mb-0 mb-md-3">
                          <a
                            className="line_2"
                            href="/ai-co-the-tro-thanh-dai-ly-den-nang-luong-mat-troi"
                  ...
                  <div className="col-12 col-md-5">
                    <article className="blog-item-list clearfix mb-3 row">
                      <div className="col-4 col-lg-3 pr-0 pl-md-0">
                        <a
                          href="/khai-truong-dai-ly-tp-solar-dai-ly-ha-an-tai-bim-son-thanh-hoa"
                        ...
                        >
                          <span className="modal-open position-relative d-block w-100 m-0 ratio3by2 has-edge aspect zoom">
                            <img
                              src="//bizweb.dktcdn.net/thumb/medium/100/463/111/articles/du-an-va-hoat-dong-180311df-2de4-4436-89b7-3f7fcb1593db.png?v=1685585640330"
                    ...
                    <article className="blog-item-list clearfix mb-3 row">
                      <div className="col-4 col-lg-3 pr-0 pl-md-0">
                        <a
                          href="/khai-truong-dai-ly-tp-solar-dai-ly-hoang-huy-tam-ky-quang-nam"
                          className=" d-block modal-open thumb_img_blog_list thumb rounded"
                    ...
                    <article className="blog-item-list clearfix mb-3 row">
                      <div className="col-4 col-lg-3 pr-0 pl-md-0">
                        <a
                          href="/tp-solar-lap-dat-den-nang-luong-mat-troi-cho-biet-thu-cua-nghe-si-le-giang"
                          className=" d-block modal-open thumb_img_blog_list thumb rounded"
                    ...
                    <article className="blog-item-list clearfix mb-3 row">
                      <div className="col-4 col-lg-3 pr-0 pl-md-0">
                        <a
                          href="/khai-truong-dai-ly-tp-solar-lac-tran-tai-dong-hoi-quang-binh"
                          className=" d-block modal-open thumb_img_blog_list thumb rounded"
                  ...
                  <div className="grid_article">
                    <div className="row" id="AjaxinateContainer">
                        ...
                        <div className="custom-article-item border mb-4 modal-open rounded-10">
                          ...
                          >
                            <div className="position-relative w-100 m-0 be_opa modal-open ratio3by2 aspect ">
                              <img
                                src={pic1}
                                data-src="../../assets/project/du-an-va-hoat-dong-4160f6fa-39ca-49aa-93f8-2a32b5b1aca8.webp"
                                className="lazy d-block img img-cover position-absolute"
                                alt="Khai trương đại lý TP Solar - Đại lý Hà An tại Bỉm Sơn, Thanh Hóa"
                              />
                            </div>
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <h3 className="title_blo font-weight-bold mb-2">
                              <a
                                ...
                                title="Khai trương đại lý TP Solar - Đại lý Hà An tại Bỉm Sơn, Thanh Hóa"
                              >
                                Khai trương đại lý TP Solar - Đại lý Hà An tại
                                Bỉm Sơn, Thanh Hóa
                              </a>
                            </h3>
                            <span className="d-block text-gray small">
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              Vừa qua,&nbsp;Công ty Cổ phần TP Solar vừa ký kết
                              phân phối sản phẩm đèn năng lượng mặt trời cùng
                              Đại lý Hà An tọa lạc tại Thị xã Bỉm Sơn, Thanh
                              Hóa, với giao thông thuận lợi, giúp quý khách có
                              thể tìm được địa chỉ bán đèn năng lượng mặt trời
                              tại Thanh Hóa nhanh chóng, cũng dễ dàng trong việc
                              vận chuyển hàng hóa. Đại lý&nbsp;Hà An chính thức
                              đi vào hoạt động, TP Solar một lần nữa mở rộng thị
                              trường trên toàn quốc, nhằm khẳng định nỗ lực
                              không ngừng, đáp ứng nhu cầu ngày càng...
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="custom-article-item border mb-4 modal-open rounded-10">
                          ...
                          >
                            <div className="position-relative w-100 m-0 be_opa modal-open ratio3by2 aspect ">
                              <img
                                src={pic1}
                                data-src="//bizweb.dktcdn.net/thumb/large/100/463/111/articles/du-an-va-hoat-dong-a8f76c16-fcbb-453e-9875-a65ad44b1fc6.png?v=1684894652370"
                                className="lazy d-block img img-cover position-absolute"
                                alt="Khai trương đại lý TP Solar - Đại lý Hoàng Huy, Tam Ky, Quảng Nam"
                              />
                            </div>
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <h3 className="title_blo font-weight-bold mb-2">
                              <a
                                ...
                                title="Khai trương đại lý TP Solar - Đại lý Hoàng Huy, Tam Ky, Quảng Nam"
                              >
                                Khai trương đại lý TP Solar - Đại lý Hoàng Huy,
                                Tam Ky, Quảng Nam
                              </a>
                            </h3>
                            <span className="d-block text-gray small">
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              Hiện nay,&nbsp;do nhu cầu sử điện tăng cao, các
                              chi phí tiền điện hay vấn đề ô nhiễm môi trường
                              đang ở mức báo động. Trước tình hình đó, ngoài sử
                              dụng điện hợp lý - Khai thác nguồn năng lượng mới
                              đang được chú trọng hàng đầu và một trong những
                              giải pháp tối ưu nhất được ứng dụng là năng lượng
                              mặt trời -&nbsp; Tận dụng 100% ánh sáng tự nhiên.
                              Nắm bắt&nbsp;cơ hội tiềm năng về đèn năng lượng
                              mặt trời, đại lý Hoàng Huy - Đại lý TP Solar quyết
                              định hợp tác với Công ty Cổ...
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <h3 className="title_blo font-weight-bold mb-2">
                              <a
                                ...
                                title="TP Solar lắp đặt đèn năng lượng mặt trời cho biệt thự của Nghệ sĩ Lê Giang"
                              >
                                TP Solar lắp đặt đèn năng lượng mặt trời cho
                                biệt thự của Nghệ sĩ Lê Giang
                              </a>
                            </h3>
                            <span className="d-block text-gray small">
                              22-05-2023
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              Nghệ&nbsp;sĩ Lê Giang chắc hẳn đã quá quen thuộc
                              với tất cả người dân Việt Nam bởi sự tài năng và
                              dí dỏm, duyên dáng của mình thông qua những tác
                              phẩm nghệ thuật hài - cải lương. Cô được người hâm
                              mộ ưu ái đặt cho những biệt danh như “Ngôi sao
                              phòng vé” mới của làng phim Việt, thông qua các
                              tác phẩm nổi tiếng như Cua lại vợ bầu, Bố già, Nhà
                              bà Nữ,... TP&nbsp;Solar Việt Nam rất vinh dự khi
                              được nghệ sĩ Lê Giang - người nghệ sĩ nổi tiếng
                              của Việt Nam ưu ái, gửi...
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <h3 className="title_blo font-weight-bold mb-2">
                              <a
                                ...
                                title="Khai trương đại lý TP Solar - Lạc Trần tại Đồng Hới, Quảng Bình"
                              >
                                Khai trương đại lý TP Solar - Lạc Trần tại Đồng
                                Hới, Quảng Bình
                              </a>
                            </h3>
                            <span className="d-block text-gray small">
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              Hiện&nbsp;nay, đèn năng lượng mặt trời được rất
                              nhiều người quan tâm đến vì có tính năng chiếu
                              sáng vượt trội mà người tiêu dùng lựa chọn để thay
                              thế đèn thông thường, bởi nó chiếu sáng miễn phí
                              và thân thiện với môi trường. Do đó, vừa qua tại
                              Thành phố Đồng hới, Quảng Bình, đại lý Lạc Trần đã
                              ký kết hợp tác cùng Công ty Cổ phần TP Solar trở
                              thành nhà phân phối độc quyền đèn năng lượng mặt
                              trời, mở ra nhiều cơ hội phát triển hơn.
                              Cùng&nbsp;với sự phát triển kinh tế, nhằm đảm
                              bảo...
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <h3 className="title_blo font-weight-bold mb-2">
                              <a
                                ...
                                title="Khai trương đại lý TP Solar - Phúc Lộc tại Vĩnh Cửu, Đồng Nai"
                              >
                                Khai trương đại lý TP Solar - Phúc Lộc tại Vĩnh
                                Cửu, Đồng Nai
                              </a>
                            </h3>
                            <span className="d-block text-gray small">
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              Hợp tác cùng phát triển Đại lý&nbsp;Phúc Lộc, một
                              trong những cửa hàng uy tín hàng đầu tại Đồng Nai
                              đã chính thức trở thành đại lý ủy quyền phân phối
                              đèn năng lượng mặt trời TP Solar tại khu vực này.
                              Đây là cột mốc đánh dấu mối quan hệ chặt chẽ giữa
                              Công ty Cổ phần TP Solar và Đại lý Phúc Lộc, góp
                              phần thúc đẩy sự tăng trưởng cũng như uy tín của
                              TP Solar trên thị trường trong nước. Cửa hàng Phúc
                              Lộc tại Đồng Nai Việc&nbsp;trở thành đại lý đèn
                              năng lượng mặt trời TP Solar sẽ...
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-12 col-sm-6 col-md-6 col-lg-4 its">
                        <div className="custom-article-item border mb-4 modal-open rounded-10">
                          <a
                            href="/chuyen-gi-xay-ra-neu-tro-thanh-dai-ly-den-nang-luong-mat-troi"
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <h3 className="title_blo font-weight-bold mb-2">
                              <a
                                ...
                                title="Chuyện gì xảy ra nếu trở thành đại lý đèn năng lượng mặt trời?"
                              >
                                Chuyện gì xảy ra nếu trở thành đại lý đèn năng
                                lượng mặt trời?
                              </a>
                            </h3>
                            <span className="d-block text-gray small">
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              Điều&nbsp;gì xảy ra nếu bạn trở thành đại lý đèn
                              năng lượng mặt trời? Bạn muốn kiếm thêm thu nhập
                              từ việc kinh doanh đèn năng lượng mặt trời? Nhưng
                              không biết tìm nguồn hàng ở đâu, chính sách dành
                              cho đại lý như nào, hay những lợi ích bạn có được
                              khi trở thành đại lý? Cùng TP Solar tìm hiểu rõ
                              hơn về vấn đề này nhé! Nguồn hàng chất lượng
                              Trên&nbsp;thị trường hiện nay, các sản phẩm đèn
                              năng lượng mặt trời được bán tràn lan, rất khó để
                              kiểm chứng chất lượng, dễ hư hỏng, tuổi thọ
                              thấp...
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="col-12 col-sm-6 col-md-6 col-lg-4 its">
                        <div className="custom-article-item border mb-4 modal-open rounded-10">
                          <a
                            href="/khai-truong-dai-ly-tp-solar-binh-anh-tai-phu-ly-ha-nam"
                      ...
                      <div className="col-12 col-sm-6 col-md-6 col-lg-4 its">
                        <div className="custom-article-item border mb-4 modal-open rounded-10">
                          <a
                            href="/tu-a-z-bi-quyet-tro-dai-ly-den-nang-luong-mat-troi-cuc-de-dang"
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              Bạn&nbsp;yêu thích và muốn kiếm thêm thu nhập từ
                              việc kinh doanh đèn năng lượng mặt trời?&nbsp;
                              Bạn&nbsp;muốn tận dụng những nguồn lực hiện có để
                              sinh thêm nhiều lợi nhuận hơn nữa? Bạn&nbsp;muốn
                              kinh doanh vì đã tìm ra phân khúc thị trường với
                              nhu cầu lớn để khai thác lợi nhuận&nbsp;tối đa
                              nhất? Bạn&nbsp;sợ nhập hàng qua khâu trung gian,
                              bị “đội” giá, bị cạnh tranh về giá? Bạn&nbsp;muốn
                              nhập nguồn&nbsp; hàng uy tín, chất lượng hàng đầu
                              Việt Nam? Mọi&nbsp;thắc mắc của bạn sẽ được giải
                              đáp&nbsp;vì đã có TP Solar Việt Nam - chúng tôi
                      ...
                      <div className="col-12 col-sm-6 col-md-6 col-lg-4 its">
                        <div className="custom-article-item border mb-4 modal-open rounded-10">
                          <a
                            href="/hoi-tro-trien-lam-san-pham-nong-nghiep-tieu-bieu-2023"
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              TP Solar&nbsp;rất vinh dự khi được cùng Hội Nông
                              dân huyện Cần Giờ mang tới hội chợ, triển lãm Đèn
                              năng lượng mặt trời - sản phẩm xanh, hướng tới nền
                              nông nghiệp bền vững. TP Solar vô cùng tự hào khi
                              các sản phẩm đèn năng lượng mặt trời nhận được sự
                              quan tâm, hưởng ứng tích cực từ các khách hàng,
                              hợp tác xã, chủ các trang trại, doanh nghiệp sản
                              xuất kinh doanh tham gia triển lãm.
                              Sáng&nbsp;21/4, tại đường Vành Đai Trong, phường
                              Bình Trị Đông B, quận Bình Tân, TP. Hồ Chí Minh tổ
                              chức hội...
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="col-12 col-sm-6 col-md-6 col-lg-4 its">
                        <div className="custom-article-item border mb-4 modal-open rounded-10">
                          <a
                            href="/ly-giai-suc-hut-cua-den-nang-luong-mat-troi-xu-huong-dau-tu-sinh-loi-cao"
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              Đèn&nbsp;năng lượng mặt trời đang là xu hướng và
                              được săn đón rất nhiều trên thị trường Việt Nam
                              hiện nay. Vậy câu hỏi được đặt ra, tại sao đèn
                              năng lượng lại có sức hút lớn như vậy?&nbsp;
                              Hãy&nbsp;cùng TP Solar&nbsp; “điểm qua” những ấn
                              tượng đáng kinh ngạc của loại đèn này nhé! “Nói
                              không” với điện lưới - An toàn -&nbsp;Hiện đại
                              Đèn&nbsp;năng lượng mặt trời không sử dụng điện
                              lưới thông thường để chiếu sáng mà nó sử dụng hoàn
                              toàn bằng ánh sáng mặt trời. Một sản phẩm vừa
                              giúp&nbsp;tiết kiệm điện, tiết kiệm chi phí tiền
                              điện,...
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="col-12 col-sm-6 col-md-6 col-lg-4 its">
                        <div className="custom-article-item border mb-4 modal-open rounded-10">
                          <a
                            href="/khai-truong-dai-ly-tp-solar-dien-co-phi-nhung-tai-long-ho-vinh-long"
                          ...
                          <div className="custom-article-item_info">
                            ...
                            <div className="sum line_1 line_2 h-auto text-justify">
                              Vừa&nbsp;qua TP Solar vui mừng chào đón đại lý
                              Điện cơ Phi Nhung, chính thức khai trương tại Long
                              Hồ, Vĩnh Long.&nbsp; Cửa&nbsp;hàng có không gian
                              được thiết kế rộng rãi thoáng đãng, trưng bày và
                              giới thiệu đa dạng các kiểu dáng các sản phẩm đèn
                              năng lượng mặt trời, đáp ứng nhu cầu của khách
                              hàng địa phương và các vùng lân cận. Đây là nơi
                              quý khách có thể tìm thấy đầy đủ các sản phẩm đèn
                              năng lượng cao cấp của thương hiệu TP Solar với
                              mức giá hợp lý.&nbsp; Bên cạnh&nbsp;sản phẩm chất
                              lượng, đội ngũ kỹ...
                            </div>
                          </div>
                        </div>
