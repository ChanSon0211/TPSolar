        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 footer-left">
              ...
              <p className="adr">
                Giấy chứng nhận Đăng ký Kinh doanh số 0109008737 do Sở Kế hoạch
                và Đầu tư Thành phố Hà Nội cấp ngày 29/11/2019
              </p>
            ...
            <div className="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 footer-left">
              <p>
                ...
                <br />
                <a className="phone" href="tel:0363993993" title="0363 993 993">
                  <i className="fa fa-phone" aria-hidden="true"></i> 0363 993
                  993
                </a>
              </p>
              <br />
              <p>
                ...
                <a
                  ...
                  title="1800 64 64 50"
                >
                  <i className="fa fa-phone" aria-hidden="true"></i> 1800 64 64
                  50
                </a>
              </p>
            </div>
      ...
      <div className="container">
        <div className="foo_mid border-top pt-4 pb-4">
          <ul className="links_sm list-unstyled row mb-0">
            <li className="col-6 col-sm-4 col-md-3 col-lg-2 m-0">
